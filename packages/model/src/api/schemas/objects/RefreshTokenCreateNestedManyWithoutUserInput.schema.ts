...
const makeSchema = () =>
  z
    ...
    .strict();
export const RefreshTokenCreateNestedManyWithoutUserInputObjectSchema: z.ZodType<Prisma.RefreshTokenCreateNestedManyWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.RefreshTokenCreateNestedManyWithoutUserInput>;
export const RefreshTokenCreateNestedManyWithoutUserInputObjectZodSchema =
  makeSchema();
