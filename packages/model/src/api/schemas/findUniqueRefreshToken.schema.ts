...
export const RefreshTokenFindUniqueSchema: z.ZodType<Prisma.RefreshTokenFindUniqueArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.RefreshTokenFindUniqueArgs>;

export const RefreshTokenFindUniqueZodSchema = z
  .object({
    select: RefreshTokenSelectObjectSchema.optional(),
    include: RefreshTokenIncludeObjectSchema.optional(),
    where: RefreshTokenWhereUniqueInputObjectSchema,
