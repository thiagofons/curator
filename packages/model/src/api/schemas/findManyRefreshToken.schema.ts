...
export const RefreshTokenFindManySelectSchema: z.ZodType<Prisma.RefreshTokenSelect> =
  z
    .object({
...
export const RefreshTokenFindManySelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    token: z.boolean().optional(),
    userId: z.boolean().optional(),
...
export const RefreshTokenFindManySchema: z.ZodType<Prisma.RefreshTokenFindManyArgs> =
  z
    .object({
      select: RefreshTokenFindManySelectSchema.optional(),
    ...
    .strict() as unknown as z.ZodType<Prisma.RefreshTokenFindManyArgs>;

export const RefreshTokenFindManyZodSchema = z
  .object({
    select: RefreshTokenFindManySelectSchema.optional(),
    include: z.lazy(() => RefreshTokenIncludeObjectSchema.optional()),
    orderBy: z
