...
export const RefreshTokenFindUniqueOrThrowSchema: z.ZodType<Prisma.RefreshTokenFindUniqueOrThrowArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.RefreshTokenFindUniqueOrThrowArgs>;

export const RefreshTokenFindUniqueOrThrowZodSchema = z
  .object({
    select: RefreshTokenSelectObjectSchema.optional(),
    include: RefreshTokenIncludeObjectSchema.optional(),
    where: RefreshTokenWhereUniqueInputObjectSchema,
