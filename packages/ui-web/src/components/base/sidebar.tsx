...
import {
	...
	SheetHeader,
	SheetTitle,
} from "@repo/ui-web/components/base/sheet";
import { Skeleton } from "@repo/ui-web/components/base/skeleton";
import {
	Tooltip,
	TooltipContent,
	TooltipProvider,
	TooltipTrigger,
} from "@repo/ui-web/components/base/tooltip";
	...
	(
		...
		const setOpen = React.useCallback(
			(value: boolean | ((value: boolean) => boolean)) => {
				...
				cookieStore.set(
					SIDEBAR_COOKIE_NAME,
					`${openState}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}`,
				);
			},
			[setOpenProp, open],
		);
