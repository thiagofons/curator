---
to: apps/backend/<%=name%>-service/src/infrastructure/messaging/index.rabbitmq.publisher.ts
---
import { User } from "@/domain/aggregates/user.aggregate";
import { UserEventPublisherPort } from "@/domain/ports/index.event-publisher.port";
